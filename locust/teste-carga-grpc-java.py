...
sys.path.insert(0, "/mnt/locust/grpc_stubs/java")

from grpc_stubs.java import musica_pb2
from grpc_stubs.java import musica_pb2_grpc

from grpc_stubs.java import playlist_pb2
from grpc_stubs.java import playlist_pb2_grpc

from grpc_stubs.java import usuario_pb2
from grpc_stubs.java import usuario_pb2_grpc


# docker compose run --rm --entrypoint sh locust -c "grep -A20 'class PlaylistServiceStub' /mnt/locust/grpc_stubs/java/playlist_pb2_grpc.py"
class GrpcUser(User):
    wait_time = between(1, 3)

    def on_start(self):
        self.channel = grpc.insecure_channel("java-grpc:8082")
